/****************************************************************************
** Meta object code from reading C++ file 'bird.hpp'
**
...
#error "The header file 'bird.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Bird_t, stringdata) + ofs \
...
const QMetaObject Bird::staticMetaObject = {
    { &GameElement::staticMetaObject, qt_meta_stringdata_Bird.data,
      qt_meta_data_Bird,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Bird.stringdata))
