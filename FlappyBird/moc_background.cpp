/****************************************************************************
** Meta object code from reading C++ file 'background.hpp'
**
...
#error "The header file 'background.hpp' doesn't include <QObject>."
...
const QMetaObject Background::staticMetaObject = {
    { &GameElement::staticMetaObject, qt_meta_stringdata_Background.data,
      qt_meta_data_Background,  qt_static_metacall, 0, 0}
};
