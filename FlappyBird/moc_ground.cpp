/****************************************************************************
** Meta object code from reading C++ file 'ground.hpp'
**
...
#error "The header file 'ground.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Ground_t, stringdata) + ofs \
...
const QMetaObject Ground::staticMetaObject = {
    { &GameElement::staticMetaObject, qt_meta_stringdata_Ground.data,
      qt_meta_data_Ground,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Ground.stringdata))
